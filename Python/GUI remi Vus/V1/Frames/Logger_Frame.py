...
class Logger_Frame(Tk.Frame):
    def __init__(self,parent,model,**kwargs):
        ...
        self.bouton_activate.grid(column=0,row=1,sticky='NEW',pady=3,padx=3)
        
        self.scrollbar_log = ttk.Scrollbar(self)
        self.scrollbar_log.grid(sticky = 'WNS', row=2, column = 2)
        
        self.var_list = ttk.Treeview(self, show="headings",columns=("name","type","size","Value"),selectmode="browse", yscrollcommand=self.scrollbar_log.set)
        self.var_list.grid(column=0,row=2,sticky='WESN',columnspan=2,pady=3,padx=(3,0))
        ...
        #self.selected_value.grid(column=1,row=4, sticky="NS")
        ...
        self.bouton_write.grid(column=1,row=4,sticky="WSNE",pady=3,padx=3)
