...
class COM_Frame(ttk.LabelFrame):
    def __init__(self,parent,model,**kwargs):
        ...
        self.Combo = ttk.Combobox( self.listbox_frame, textvariable=self.PortCom, values=self.listPorts)
        self.Combo.grid(column=0,row=0,sticky="WENS")
    ...
    def refresh_COM_ports(self):
        ...
        self.Combo.destroy()
        self.Combo = ttk.Combobox( self.listbox_frame, textvariable=self.PortCom, values=self.listPorts_desc)
        self.Combo.grid(column=0,row=0,sticky="WENS")
       # self.PortCom.set(self.listPorts_desc[0])
