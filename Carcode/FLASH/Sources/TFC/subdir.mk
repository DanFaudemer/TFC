...
"../Sources/TFC/communication_uart.c" \
...
./Sources/TFC/communication_uart.o \
...
./Sources/TFC/communication_uart.d \
...
Sources/TFC/communication_uart.o: ../Sources/TFC/communication_uart.c
	...
	@echo 'Invoking: ARM Ltd Windows GCC C Compiler'
	"$(ARMSourceryDirEnv)/arm-none-eabi-gcc" "$<" @"Sources/TFC/communication_uart.args" -Wa,-adhlns="$@.lst" -MMD -MP -MF"$(@:%.o=%.d)" -o"Sources/TFC/communication_uart.o"
	@echo 'Finished building: $<'
	@echo ' '
