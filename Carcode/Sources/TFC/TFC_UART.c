...
void TFC_InitUARTs()
{
	...
	/* See chapter 10.3 ALT function  */
	
	/* Set uart 0 RX & TX on PORTA_PCR1 (Debug throught speed sensor & bluetooth) */
...
void UART0_IRQHandler()
{
	...
	if(UART0_S1 & UART_S1_RDRF_MASK)//Receive queue full
	{
		ByteEnqueue(&SDA_SERIAL_INCOMING_QUEUE,UART0_D);
	}
	if(UART0_S1 & UART_S1_TDRE_MASK) //Tx empty
	{
